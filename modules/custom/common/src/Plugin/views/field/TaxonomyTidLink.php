...
/**
 * @file
 * Definition of Drupal\d8views\Plugin\views\field\TaxonomyTidLink
 */

namespace Drupal\common\Plugin\views\field;
 ...
 *
 * @ViewsField("taxonomy_tid_link")
 */
class TaxonomyTidLink extends FieldPluginBase {
